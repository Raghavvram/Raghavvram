...
| Software Development     | OOP, Data Structures, Embedded Programming, API Design & Integration, REST APIs, Full-Stack Development (React.js, Node.js, Flask, Django), Android Studio, Git, GitHub, GitHub Actions, SVN                  |
| Systems & OS             | Linux (Arch, Hyprland), Windows, macOS, Shell Scripting, CLI Tools, Computer Architecture, Digital Logic                                                                                                      |
| Cybersecurity            | System Hardening, Vulnerability Assessment & Management, Penetration Testing, Security Audits, IAM, RBAC, Encryption, Firewall & IDS/IPS Configuration, SIEM, SOAR, Incident Response, Digital Forensics     |
| DevOps & Infrastructure  | Docker, Podman, Kubernetes, LXC, Ansible, Serverless Architecture, Infrastructure Automation, Self-hosting, Linux Server Administration, Virtualization (Proxmox, VMware, VirtualBox, KVM), DNS, DHCP         |
| Cloud & Database         | AWS, Azure, GCP, MySQL, PostgreSQL, Oracle, Redis, MongoDB, DBMS, Data Analysis                                                                                                                               |
| Machine Learning & AI    | ML & DL (TensorFlow, PyTorch, Keras), CUDA, LSTM, RNN, GRU                                                                                                                                                    |
| Security Tools           | Wireshark, Nmap, Aircrack-ng, Burp Suite, Bettercap, Metasploit, OpenVAS, SET                                                                                                                                |
| Productivity & Standards | Microsoft Office Suite, ISO 27001, ISO 9001, NIST Framework, Cybersecurity Law                                                                                                                               |
