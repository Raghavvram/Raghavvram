...
| Frameworks                  | Flask, Django, React.js, Node.js                                                                                                                                                                                |
| Libraries                   | Pandas, NumPy, TensorFlow, PyTorch, Keras                                                                                                                                                                       |
| Systems, OS & Infrastructure| Linux (Arch, Hyprland), Windows, macOS, Windows Server, Linux Administration, Shell Scripting, CLI Tools, Computer Architecture, Digital Logic, DNS, DHCP, Active Directory, AD FS, AD CS, Group Policy         |
| Cybersecurity               | Vulnerability Assessment & Management, Penetration Testing, Security Audits, IAM, RBAC, Encryption, Firewall Configuration, IDS/IPS, Endpoint Security, Incident Response, Digital Forensics, Cyber Threats, Network Security, Network Protocols, VPNs, Network Access Control, Cybersecurity Law, System Hardening, Zero Trust Architecture |
| DevOps & Cloud              | Docker, Podman, Kubernetes, LXC, Ansible, Serverless Architecture, Infrastructure Automation, Self-hosting, Proxmox, VMware, VirtualBox, KVM, AWS, Azure, GCP                                                   |
| Database                    | MySQL, PostgreSQL, Oracle, Redis, MongoDB, DBMS, Database Administration, MySQL Workbench, Oracle SQL Developer, Data Analysis                                                                                 |
| Machine Learning & AI       | Machine Learning, Deep Learning, LSTM, RNN, GRU, CUDA                                                                                                                                                           |
| Security Tools & Standards  | Wireshark, Nmap, Aircrack-ng, Burp Suite, Bettercap, Metasploit, OpenVAS, Social Engineering Toolkit (SET), SIEM, SOAR, ISO 27001, ISO 9001, NIST Framework                                                   |
| Productivity & Tools        | Microsoft Office Suite (Excel, Word, PowerPoint), Git, GitHub, GitHub Actions, SVN                                                                                                                             |
